...
function cargarComentarios(page){
    ...
    conexionComentarios.open('GET',"http://127.0.0.1/backend/tweetComments.php?api_key="+getCookie("api_key")+"&tweet_id="+tweet_id+"&page="+page);
...
input.addEventListener("keyup", function(event) {
    if (event.keyCode === 13) {
      ...
      conexionEscribirComentario.open('GET',"http://127.0.0.1/backend/comment.php?api_key="+getCookie("api_key")+"&tweet_id="+tweet_id+"&content="+input.value);
