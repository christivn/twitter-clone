...
function cargarTweets(page){
    ...
    conexion.open('GET',"http://127.0.0.1/backend/notificationFeed.php?api_key="+getCookie("api_key")+"&page="+page);
    conexion.send();
        ...
        if(conexion.readyState == 4 && conexion.status == 200) {
            if(conexion.responseText.length>0){
                ...
                for(let i=0;i<data.length;i++){
                    ...
                    if(imageExists("/backend/img/"+data[i].user_id+"_avatar.jpg")){
                        ...
                        <div class="tweet" id="`+data[i].tweet_id+`">
                            ...
                            <div class="contenido-tweet">
                                ...
                                <p style="margin-top:0px;color:#E0245E;font-weight: bold;">
                                    ...
                                    Ha `+data[i].name_twitter+` le ha gustado tu tweet: <span style="color:black;font-weight: normal;"><a href="tweet.html?tweet_id=`+data[i].tweet_id+`">Ver tweet</a></span>
                                </p>
                            </div>
                        </div>
                        `;
                        ...
                        <div class="tweet" id="`+data[i].tweet_id+`">
                            ...
                            <div class="contenido-tweet">
                                ...
                                <p style="margin-top:0px;color:#55CE8C;font-weight: bold;">
                                    ...
                                    Ha `+data[i].name_twitter+` ha dado rt tu tweet: <span style="color:black;font-weight: normal;"><a href="tweet.html?tweet_id=`+data[i].tweet_id+`">Ver tweet</a></span>
                                </p>
                            </div>
                        </div>
                        `;
                        ...
                        <div class="tweet" id="`+data[i].tweet_id+`">
                            ...
                            <div class="contenido-tweet">
                                ...
                                <p style="margin-top:0px;color:#2FA9F3;font-weight: bold;">
                                    ...
                                    Ha `+data[i].name_twitter+` ha comentado en tu tweet: <span style="color:black;font-weight: normal;"><a href="tweet.html?tweet_id=`+data[i].tweet_id+`">Ver tweet</a></span>
                                </p>
                            </div>
                        </div>
                        `;
