...
function actualizar(){
    if(boton.classList.contains("seguir")){
        ...
        function follow(){
            ...
            conexion.open('GET',"http://127.0.0.1/backend/follow.php?api_key="+api_key+"&followed_id="+id);
            conexion.send();
        ...
        function unfollow(){
            ...
            conexion.open('GET',"http://127.0.0.1/backend/unfollow.php?api_key="+api_key+"&followed_id="+id);
            conexion.send();
