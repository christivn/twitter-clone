...
function fav(tweet_id){
    ...
    if(fav_false){
        ...
        conexion_fav.open('GET',"http://christivn.es/api/fav.php?api_key="+getCookie("api_key")+"&tweet_id="+tweet_id);
        conexion_fav.send();
        ...
        conexion_fav=new XMLHttpRequest();
        conexion_fav.addEventListener('readystatechange',callBackFav);
        conexion_fav.open('GET',"http://christivn.es/api/fav_remove.php?api_key="+getCookie("api_key")+"&tweet_id="+tweet_id);
        conexion_fav.send();
...
function rt(tweet_id){
    ...
    if(rt_false){
        ...
        conexion_rt.open('GET',"http://christivn.es/api/rt.php?api_key="+getCookie("api_key")+"&tweet_id="+tweet_id);
        conexion_rt.send();
        ...
        conexion_rt=new XMLHttpRequest();
        conexion_rt.addEventListener('readystatechange',callBackRt);
        conexion_rt.open('GET',"http://christivn.es/api/rt_remove.php?api_key="+getCookie("api_key")+"&tweet_id="+tweet_id);
        conexion_rt.send();
...
function comments(tweet_id){
    window.location.href = "tweet?tweet_id="+tweet_id;
}
