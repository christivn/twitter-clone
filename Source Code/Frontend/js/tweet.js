...
conexion.open('GET',"http://christivn.es/api/tweetPage.php?api_key="+getCookie("api_key")+"&tweet_id="+tweet_id);
conexion.send();
    ...
    if(conexion.readyState == 4 && conexion.status == 200) {
        if(conexion.responseText.length>0){
            ...
            for(let i=0;i<data.length;i++){
                ...
                if(imageExists("http://christivn.es/api/img/"+getCookie("id")+"_avatar.jpg")){
                    document.getElementById("foto-perfil-comentario").src="http://christivn.es/api/img/"+getCookie("id")+"_avatar.jpg";
                }
