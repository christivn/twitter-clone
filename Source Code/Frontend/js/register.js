...
function peticionRegistro(usuario,pass,bio,nameic) {
    ...
    conexion.open('POST',"http://christivn.es/api/register.php?nick="+usuario+"&pass="+pass+"&bio="+bio+"&nameic="+nameic);
    conexion.send();
}
...
function login(nick,pass){
    ...
    conexion.open('GET',"http://christivn.es/api/login.php?nick="+nick+"&pass="+pass);
    conexion.send();
}
