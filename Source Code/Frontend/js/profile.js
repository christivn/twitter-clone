...
conexion.open('GET',"http://christivn.es/api/profile.php?api_key="+getCookie("api_key")+"&id="+id);
conexion.send();
    ...
    if(conexion.readyState == 4 && conexion.status == 200) {
        ...
        if(data.code=="200"){
            ...
            function cargarTweets(page){
                ...
                conexion_profile_feed.open('GET',"http://christivn.es/api/profileFeed.php?api_key="+getCookie("api_key")+"&id="+id+"&page="+page);
...
function mostrarModal(tweet_id){
    ...
    botonEliminar.onclick = function() {
        ...
        conexionEliminar.open('GET',"http://christivn.es/api/deleteTweet.php?api_key="+getCookie("api_key")+"&tweet_id="+tweet_id);
