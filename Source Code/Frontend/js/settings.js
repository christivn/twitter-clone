...
function guardarAjustes(){
    ...
    conexionSettings.open('GET',"http://christivn.es/api/settings.php?api_key="+getCookie("api_key")+"&avatar_url="+avatar_url+"&banner_url="+banner_url+"&name="+name_twitter+"&bio="+bio);
