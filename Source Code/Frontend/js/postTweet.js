...
if(imageExists("http://christivn.es/api/img/"+getCookie("id")+"_avatar.jpg")){
    document.getElementById("foto-tweet").src="http://christivn.es/api/img/"+getCookie("id")+"_avatar.jpg";
}
...
function tweet(){
    ...
    if(content.length>=1){
        ...
        conexionTweetear.open('GET',"http://christivn.es/api/tweet.php?api_key="+getCookie("api_key")+"&content="+content+"&img_url="+img);
